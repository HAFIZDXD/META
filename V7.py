...
[{H}3{U}]{H} Cek Harga License {U}{H}{U}{H}
""")#line:49
    OOO00O0OOO00OO00O =input (f"{H}[{H}?{H}]{H} Choose :{K} ")#line:50
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      print (f"{H}[{H}!{H}]{H} Send Message..");time .sleep (3 );os.system('xdg-open https://wa.me/6285758862225?text=assalamualaikum');exit ()#line:52
