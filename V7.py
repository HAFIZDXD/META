...
def license():#line:42
  try :#line:43
    ...
    os.system("git pull")
    print (f"""
{U}[{b}1{U}]{b} Beli License
{U}[{b}2{U}]{b} Masukan License
{U}[{b}3{U}]{b} List Harga License {U}{H}{U}{H}
""")#line:49
    OOO00O0OOO00OO00O =input (f"{H}[{H}?{H}]{H} Choose :{K} ")#line:50
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      print (f"{H}[{H}!{H}]{H} Send Message..");time .sleep (3 );os .system ('xdg-open https://wa.me/6285758862225/?text=Mas+Saya+Mau+Beli+License');exit ()#line:52
